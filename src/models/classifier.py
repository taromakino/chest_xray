...
from src.models.backbone.vgg import (vgg19, vgg19_bn)
from src.models.backbone.densenet import (densenet121, densenet169, densenet201)
from src.models.backbone.inception import (inception_v3)
from src.models.global_pool import GlobalPool
from src.models.attention_map import AttentionMap
...
#         with open('/gpfs/data/razavianlab/skynet/alzheimers/ukbiobank/CNN_design_for_AD/covid_project/coronavirus_local_copy/example.json') as f:
#             cfg = AttrDict(json.load(f))
        ...
        self.multiclass = self.cfg.multiclass
...
#                 logit_maps.append(logit_map)
        ...
        if self.multiclass:
            ...
            logits = torch.sigmoid(torch.cat(logits,dim = 1))
